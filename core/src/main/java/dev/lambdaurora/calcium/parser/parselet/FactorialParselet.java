...
import dev.lambdaurora.calcium.expression.FactorialExpression;
...
/**
 * Parses factorial expressions.
 */
public class FactorialParselet implements InfixParselet {
    @Override
    public Expression parse(Parser parser, Expression left, Token token) throws ParseException {
        return new FactorialExpression(left);
    }
